...
final class DummyData {
    ...
    static func generateDummyPokemon(num: Int) -> [PokemonDomainModel] {
        var pokemons = [PokemonDomainModel]()
        for i in 0..<num {
            pokemons.append(
    ...
    static func generatePokemon(id: Int) -> PokemonDomainModel {
    ...
    static func generatePokemonSpecies(id: Int) -> PokemonSpeciesDomainModel {
